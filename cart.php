...
?>
        <div style="display:flex;margin:12px"><!-- cart starts -->
            ...
            <div style="width:12px;margin-top:42px;margin-right:15px" onclick=""><i class="fa fa-times" style="background-color:red;color:#fff;padding:3px;border-radius:100%"></i></div>
        </div><!-- cart ends -->
