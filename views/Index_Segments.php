        ...
        echo <<<HTML
            <div class="headers"> <!-- start of .headers --> 
                ...
                <div class="header_shopping_cart">
                    <span style="font-size:12px;padding:1.5px 4.5px;margin-left:-4px;border-radius:100%;color:#fff;background-color:#ff9100">$number_of_products_in_cart</span><a href="/cart"><img src="/static/images/shopping_cart.png"/><!--<i class="fa fa-shopping-cart" style="color:#ff9100"></i>--></a>
                </div> 
