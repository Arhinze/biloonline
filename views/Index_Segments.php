...
HTML;
            ...
            if ($whatsapp_chat == "on") {
                echo <<<HTML
                    <!-- .whatsapp_box starts -->
                    <div class="whatsapp_box" id="whatsapp_box" style="display:none;position:fixed;bottom:78px;right:18px;background-color:#fff;border-radius:9px;width:75%;box-shadow:0 0 3px 0 #888">
                    ...
                    <div class="footer_menu" style="position:fixed;width:100%;padding:12px;display:flex;flex:3 3 auto;background-color:#fff">
                        <div class="footer_menu_items">
                            <div style="font-weight:39px"><i class="fa fa-home"></i></div>
                            <div style="font-weight:14px">Home</div>
                        </div>
                        <div class="footer_menu_items">
                            <div style="font-weight:39px"><i class="fa fa-file-text-o"></i></div>
                            <div style="font-weight:14px">Categories</div>
                        </div>
                        <div class="footer_menu_items">
                            <div style="font-weight:39px"><img src="/static/images/shopping_cart.png"/></div>
                            <div style="font-weight:14px">Cart</div>
                        </div>
                        <div class="footer_menu_items">
                        ...
                        <div class="footer_menu_items">
                            ...
                            <div style="font-weight:14px">Account</div>
                        </div>
                    </div>
HTML;
            }
