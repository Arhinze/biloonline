<div style="display:flex">
    ...
    <div style="margin-top:12px;width:60%"><input type = "number" placeholder = "The 6 Digit Code: example - 123456" name = "user_code" class="input" style="height:30px;width:fit-content"/></div>
</div>